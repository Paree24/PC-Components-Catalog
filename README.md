...
We have created pages for inserting values into all the tables. Then to display all the tables, to delete the details from the tables that is already created, to check for compatibility and price per rupee. We can also increase or decrease the Peripheral prices by 100 rupees.
